...
public class ActivityCdServiceTest {
    ...
    public void testLookup() {
        ...
        //Assertions.assertEquals(2, activityCdService.total(), "total should return 2 activityCds");
    }
    ...
    void testFindById() {
        ...
        Assertions.assertSame(returnedActivityCd.get(), activityCd1, "The ActivityCd returned was not the same as the mock");
    }
